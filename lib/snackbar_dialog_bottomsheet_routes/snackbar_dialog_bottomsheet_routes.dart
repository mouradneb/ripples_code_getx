...
import 'next_screen_named.dart';
import 'next_screen_unamed.dart';

class SnackBar_defaultDialog_Bottomsheet_Routes extends StatelessWidget {
  @override
    ...
    return ScreenUtilInit(
      ...
      builder: () => GetMaterialApp(
        ...
        getPages: [
          GetPage(
              name: "/",
              page: () => SnackBar_defaultDialog_Bottomsheet_Routes()),
          GetPage(
            //name: "/next_screen/:id",
            name: "/next_screen",
